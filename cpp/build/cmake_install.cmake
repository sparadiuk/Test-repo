# Install script for directory: /home/user151137/work/Projects/KAA/kaa-all/sample-apps/powerplant/source/cpp
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  if(EXISTS "$ENV{DESTDIR}/usr/local/sbin/powerplant_demo" AND
  ...
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/sbin/powerplant_demo")
...
file(INSTALL DESTINATION "/usr/local/sbin" TYPE EXECUTABLE FILES "/home/user151137/work/Projects/KAA/kaa-all/sample-apps/powerplant/source/cpp/build/powerplant_demo")
  if(EXISTS "$ENV{DESTDIR}/usr/local/sbin/powerplant_demo" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/sbin/powerplant_demo")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/sbin/powerplant_demo"
...
file(WRITE "/home/user151137/work/Projects/KAA/kaa-all/sample-apps/powerplant/source/cpp/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
